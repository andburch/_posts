...
output:
  html_document:
    ...
    fig_caption:  true
---
[(Second post here)]({{ site.baseurl }}{% post_url 2018-09-28-honeypot_images %})
...
One town of kooky Poocherans(?) aside though, ants are not usually depicted in public art. However, there is one ant that features prominently in murals and has gained global cultural acknowledgment.
...
[^2]: Here's [a photo I took of an Australian "scribbly" gum tree]({{ site.url }}/_posts/figures/static_files/honeys/scribbly.jpg). I mean, yeah, I get it, okay? Scribbles, yeah cool.
